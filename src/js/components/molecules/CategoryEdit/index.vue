<template lang="html">
  <form @submit.prevent="handleSubmit">
    ...
    <div class="category-management-edit__notice" v-if="errMessage">
      <app-text bg-error>{{ errMessage }}</app-text>
    </div>

    <div class="category-management-edit__notice" v-if="doneMessage">
